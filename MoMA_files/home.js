webpackJsonp(
    [3],
    {
        24: function (t, e, i) {
            ...
            (function (t) {
                function e() {
                    t("[data-sidebar-upper]").each(function (e, i) {
                        var s = t(i),
                            n = s.height(),
                            o = s.children("[data-sidebar-left]"),
                            r = o.children("span"),
                            a = s.children("[data-sidebar-right]"),
                            h = a.children("span");
                        r.height(n), h.height(n);
                        var l = r.prop("scrollWidth"),
                            c = h.prop("scrollWidth"),
                            d = r.width(),
                            p = h.width(),
                            u = l > c ? l : c,
                            g = l > c ? d : p,
                            m = Math.ceil(u / g),
                            f = parseInt(r.css("margin-right"));
                        o.width(m * g + f), r.width(m * g), a.width(m * g + f), h.width(m * g);
                    });
                }
                function s() {
                    t("[data-sidebar-left]").each(function (e, i) {
                        t(i).addClass("sidebar--active");
                    }),
                        t("[data-sidebar-right]").each(function (e, i) {
                            t(i).addClass("sidebar--active");
                        });
                }
                i(25), (window.MoMA = window.MoMA || {});
                var n = i(1),
                    o = n.View.extend({
                        queue: [],
                        initialize: function () {
                            this.getMoreWorks(), t("[data-home-collection-works-image]").bind("animationend", this.onTransitionEnd.bind(this));
                        },
                        getMoreWorks: function () {
                            /*t.ajax({ url: "/collection/random-works.json", cache: !1, context: this }).done(this.mergeNewImages.bind(this));*/
                        },
                        mergeNewImages: function (t) {
                            var e = this,
                                i = t
                                    .map(function (t) {
                                        return t.url;
                                    ...
                                    .filter(function (t) {
                                        return !e.queueIncludes(t);
                                    });
                            this.queue = this.queue.concat(i);
                        },
                        queueIncludes: function (t) {
                            var e = !0,
                                i = !1,
                                s = void 0;
                            try {
                                for (var n, o = this.queue[Symbol.iterator](); !(e = (n = o.next()).done); e = !0) if (n.value == t) return !0;
                            } catch (t) {
                                (i = !0), (s = t);
                            } finally {
                                try {
                        ...
                        onTransitionEnd: function () {
                            this.getMoreWorksIfRequired(), t("[data-home-collection-works-image]").removeClass("home__collection__image--transition");
                            var e = t("[data-home-collection-works-image]").clone(),
                                i = t("[data-home-collection-works-container]");
                            e.attr("src", this.queue.pop()),
                                e.bind("animationend", this.onTransitionEnd.bind(this)),
                                e.bind("onreadystatechange load", function () {
                                    e.addClass("home__collection__image--transition"), e.removeClass("home__collection__image--hidden");
                                }),
                                e.addClass("home__collection__image--hidden"),
                                i.children().replaceWith(e);
                        },
                        getMoreWorksIfRequired: function () {
                            this.queue.length < 5 && this.getMoreWorks();
                        },
                    }),
                    r = n.View.extend({
                        transitionClass: "home__sponsors-list__logo--transition",
                        initialize: function () {
                            this.populateQueue();
                            var e = t(this.queue.pop());
                            e.bind("animationend", this.onTransitionEnd.bind(this)), e.addClass(this.transitionClass);
                        },
                        populateQueue: function () {
                            this.queue = t.makeArray(t("[data-home-page-sponsor]"));
                        },
                        onTransitionEnd: function () {
                            0 == this.queue.length && this.populateQueue();
                            var e = t("." + this.transitionClass);
                            e.removeClass(this.transitionClass), e.off();
                            var i = t(this.queue.pop());
                            i.bind("animationend", this.onTransitionEnd.bind(this)), i.addClass(this.transitionClass);
                        },
                    });
                t(function () {
                    new o({ el: t("[data-home-collection-works]") }),
                        new r({ el: null }),
                        (window.MoMA.owlCarousel = t(".owl-carousel").owlCarousel({
                            autoplay: !0,
                            autoplayHoverPause: !0,
                            autoplayTimeout: 5e3,
                            center: !0,
                            dotClass: "home__carousel-controls__dot",
                            dots: !0,
                            dotsClass: "home__carousel-controls",
                            items: 1,
                            loop: !1,
                            nav: !1,
                            navContainer: " ",
                            ...
                            rewind: !0,
                            smartSpeed: 400,
                            stageOuterClass: "home__carousel-stage",
                            startPosition: 0,
                        }));
                }),
                    t(window).on("load", function () {
                        ...
                        t(window).resize(function () {
                            window.clearTimeout(i), (i = window.setTimeout(e, 250));
                        });
                    });
            }.call(e, i(0)));
        },
                ...
                !(function (t, i, s, n) {
                    ...
                    (o.Defaults = {
                        ...
                        (o.prototype.viewport = function () {
                            var e;
                            if (this.options.responsiveBaseElement !== i) e = t(this.options.responsiveBaseElement).width();
                        ...
                        (o.prototype.destroy = function () {
                            this.$element.off(".owl.core"), this.$stage.off(".owl.core"), t(s).off(".owl.core"), !1 !== this.settings.responsive && (i.clearTimeout(this.resizeTimer), this.off(i, "resize", this._handlers.onThrottledResize));
                            ...
                            (n.prototype.play = function (e) {
                                ...
                                this._playing ||
                                    ...
                                    "youtube" === o.type
                                        ...
                                        : "vzaar" === o.type &&
                                          (i = '<iframe frameborder="0"height="' + a + '"width="' + r + '" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/' + o.id + '/player?autoplay=true"></iframe>'),
